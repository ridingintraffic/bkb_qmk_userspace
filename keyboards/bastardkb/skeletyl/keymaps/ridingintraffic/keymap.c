...
MT(MOD_LSFT, KC_Z),    KC_X,    KC_C,    KC_V,                KC_B, KC_N,    KC_M,                KC_COMM, KC_DOT,  MT(MOD_LSFT, KC_SLSH) ,
                                MT(MOD_LSFT, KC_UNDS), KC_LGUI, MT(MOD_MEH, KC_BSPC), MT(MOD_MEH, KC_SPC), MT(MOD_HYPR, KC_ENT), MT(MOD_LSFT, KC_MINUS)
),

  [1] = LAYOUT_split_3x5_3(
QK_GESC, KC_VOLD, KC_VOLU, KC_LCBR, KC_LBRC,              KC_RBRC, KC_RCBR, KC_NO, KC_NO, KC_MPLY, 
KC_GRV, KC_NO, KC_NO, KC_NO, KC_SCLN,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_DQT, 
KC_TILDE, _______, KC_CPYW, KC_CPYP, KC_LBRC,             KC_RBRC, KC_MINUS, KC_EQL, KC_PIPE,  KC_BSLS, 
